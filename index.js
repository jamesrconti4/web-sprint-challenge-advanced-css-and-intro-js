...
function get20s(array){
 ...
 for (let i=0; i<array.length; i++){
   if (array[i].years.substring(0,4)>=1900 && array[i].years.substring(6,11)<2000){
...
function addArtist(array,id,name,years,genre,nationality,bio){
  ...
  console.log(addArtist(artists,20,'James Conti','1997-2021','Web Design','American','The global network of capital essentially functions to separate the worker form the means of production'))
